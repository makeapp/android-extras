    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tagButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
              ...
              if (!TextUtils.isEmpty(tag1KeyStr) && !TextUtils.isEmpty(tag1ValueStr)) {
                  map.put(tag1KeyStr, tag1ValueStr);
              }
              if (!TextUtils.isEmpty(tag2KeyStr) && !TextUtils.isEmpty(tag2ValueStr)) {
                  map.put(tag2KeyStr, tag2ValueStr);
              }

              PushManager.setTags(getApplicationContext(), map);
            }
        });
        ...
        delButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                list.add(delKeyStr);
                PushManager.deleteTags(getApplicationContext(), list);
            }
        });
        ...
        getButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                Map<String, String> tags = PushManager.getTags(getApplicationContext());
                if (null != tags && !tags.isEmpty()) {
                    for (Map.Entry<String, String> mapEntry : tags.entrySet()) {
                        String key = mapEntry.getKey();
                        String value = mapEntry.getValue();
                        Log.i(TAG, "tagKey:"+ key + "/tagValue:" + value);
                    }
                } else {
                    Log.i(TAG, "no tags");
                }
        ...
        openLocationBtn.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                PushManager.enableFeature(TagReportActivity.this, null, true);
            }
        });
        ...
        closeLocationBtn.setOnClickListener(new View.OnClickListener() {
            ...
            @Override
            public void onClick(View view) {
                PushManager.enableFeature(TagReportActivity.this, null, false);
            }
        });
    }
